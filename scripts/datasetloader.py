...
train_ds = CacheDataset(training_dataset,transform=train_transforms,num_workers=0,progress=True)
validation_ds = CacheDataset(validation_dataset,transform=val_transforms,num_workers=0,progress=True)
testing_ds = CacheDataset(test_dataset,transform=val_transforms,num_workers=0,progress=True)
